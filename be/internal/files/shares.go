...
func PublicListingHTML(shareBaseURL, relPath, dirName string, entries []os.DirEntry) string {
	...
	b.WriteString("body{padding-bottom:24px}")
	b.WriteString("h1{font-size:15px;color:#a1a1aa;font-weight:600;word-break:break-all;max-width:760px;margin:20px auto 16px;padding:0 16px}")
	b.WriteString("ul{list-style:none;padding:0 16px;max-width:760px;margin:0 auto}")
